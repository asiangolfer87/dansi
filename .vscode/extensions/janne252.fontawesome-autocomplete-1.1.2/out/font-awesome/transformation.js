    ...
    format(value, delimiter, format) {
        ...
        switch (format) {
            case InsertionTemplateTokenFormat.PascalCase:
                return string_1.setCharacterCase(tokens.map(token => string_1.setCharacterCase(token, 0, 'upper')).join(''), 0, 'upper');
            case InsertionTemplateTokenFormat.CamelCase:
                return string_1.setCharacterCase(tokens.map(token => string_1.setCharacterCase(token, 0, 'upper')).join(''), 0, 'lower');
