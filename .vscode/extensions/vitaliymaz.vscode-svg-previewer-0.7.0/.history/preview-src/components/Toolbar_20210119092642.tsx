...
interface ToolbarProps {
  onChangeBackgroundButtonClick: JSX.MouseEventHandler<any>;
  zoomIn: Function;
  zoomOut: Function;
  zoomReset: Function;
  fileSize?: string;
  sourceImageValidity: boolean;
  onBtnMouseDown: JSX.MouseEventHandler<any>;
  activeBtn?: string;
  onToggleTransparencyGridClick: JSX.MouseEventHandler<any>;
  onToggleBoundingBoxClick: JSX.MouseEventHandler<any>;
  scale: number;
  background: string;
  ...
  <div className='toolbar'>
    <div className='btn-group'>
      <button
        ...
        onClick={zoomIn as JSX.MouseEventHandler<any>}
      ...
      <button
        ...
        disabled={!sourceImageValidity}
        onClick={zoomOut as JSX.MouseEventHandler<any>}
        onMouseDown={onBtnMouseDown}
        title='Zoom Out'
      >
      ...
      <button
        ...
        onClick={zoomReset as JSX.MouseEventHandler<any>}
        onMouseDown={onBtnMouseDown}
        title='Zoom Reset'
      >
