...
import { TELEMETRY_EVENT_TOGGLE_BOUNDING_BOX_, TELEMETRY_EVENT_TOGGLE_TRANSPARENCY_GRID } from '../telemetry/events'
  ...
  constructor (
    ...
    this._panel.webview.onDidReceiveMessage(message => {
      ...
      if (message.command === 'changeBoundingBoxVisibility') {
        ...
        this.telemetryReporter.sendTelemetryEvent(TELEMETRY_EVENT_TOGGLE_BOUNDING_BOX_, { visible: message.payload.visible })
      }
